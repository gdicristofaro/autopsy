...
public class CTIntegrationMissingDialog extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CTIntegrationMissingDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CTIntegrationMissingDialog dialog = new CTIntegrationMissingDialog(new javax.swing.JFrame(), true);
