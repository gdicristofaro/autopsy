        ...
        if (phoneNumber != null || homePhoneNumber != null || mobilePhoneNumber != null || hasAnEmail) {
            ...
            if (!additionalAttributes.isEmpty()) {
                BlackboardArtifact artifact = (parent instanceof AbstractFile)
                        ? ((AbstractFile) parent).newDataArtifact(new BlackboardArtifact.Type(BlackboardArtifact.Type.TSK_CONTACT), additionalAttributes)
                        : parent.newDataArtifact(new BlackboardArtifact.Type(BlackboardArtifact.Type.TSK_CONTACT), additionalAttributes, null);
