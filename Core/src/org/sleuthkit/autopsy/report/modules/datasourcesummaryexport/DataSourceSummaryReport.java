...
import org.sleuthkit.autopsy.datasourcesummary.ui.ExcelExportAction;
...
public class DataSourceSummaryReport implements GeneralReportModule {
    ...
    private static final ExcelExportAction exportAction = new DataSourceSummaryTabbedPane().getExportAction();
    ...
    public void generateReport(GeneralReportSettings settings, ReportProgressPanel progressPanel) {
        ...
        for (Content dataSource : selectedDataSources){
            if (dataSource instanceof DataSource) {
                try {
                    exportAction.exportToXLSX(progressPanel, (DataSource) dataSource, settings.getReportDirectoryPath());
                } catch (IOException | ExcelExport.ExcelExportException | InterruptedException ex) {
