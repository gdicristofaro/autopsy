...
final class InterestingArtifactCreatorIngestModule extends FileIngestModuleAdapter {
    ...
    private static final String INT_ARTIFACT_TYPE_NAME = BlackboardArtifact.Type.TSK_INTERESTING_ARTIFACT_HIT.getTypeName();
    private static final String INT_ARTIFACT_DISPLAY_NAME = BlackboardArtifact.Type.TSK_INTERESTING_ARTIFACT_HIT.getDisplayName();
